...
func main() {
	...
	mux := goji.NewMux()
	getNewRelicWrap := func(path string, f func(w http.ResponseWriter, r *http.Request)) (goji.Pattern, func(w http.ResponseWriter, r *http.Request)) {
	...
	mux.HandleFunc(getNewRelicWrap("/login", getIndex))
	mux.HandleFunc(getNewRelicWrap("/register", getIndex))
	mux.HandleFunc(getNewRelicWrap("/timeline", getIndex))
	mux.HandleFunc(getNewRelicWrap("/categories/:category_id/items", getIndex))
	mux.HandleFunc(getNewRelicWrap("/sell", getIndex))
	mux.HandleFunc(getNewRelicWrap("/items/:item_id", getIndex))
	mux.HandleFunc(getNewRelicWrap("/items/:item_id/edit", getIndex))
	mux.HandleFunc(getNewRelicWrap("/items/:item_id/buy", getIndex))
	mux.HandleFunc(getNewRelicWrap("/buy/complete", getIndex))
	mux.HandleFunc(getNewRelicWrap("/transactions/:transaction_id", getIndex))
	mux.HandleFunc(getNewRelicWrap("/users/:user_id", getIndex))
	mux.HandleFunc(getNewRelicWrap("/users/setting", getIndex))
	// Assets
